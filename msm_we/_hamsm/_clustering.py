...
class ClusteringMixin:
    ...
    def do_stratified_clustering(self: "modelWE", arg):
        ...
        max_iter_for_clustering_loop = (np.max(iters_to_use))+1 
        # Cast to a list in case it's a np array
        iters_to_use = list(iters_to_use)
        ...
        iteration = -1
        # Maybe not even necessary to track iter_coords, just _iter_coords.
        # Collect all data for all WE iteration at once to remove the step of nearest fill bin.  
        ...
        # Map coords to WE bins. This is done to check that every WE bins have segments this section of code remaining
        ...
        #Included to remove pcoord_is_target_or_basis
    ...
    def get_cluster_centers(self: "modelWE"):
        ...
        #The above line commented for numpy3.10version compatible.
