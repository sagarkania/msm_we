...
class DataMixin:
    ...
    **TODO**: Deprecate this, this could just be a property"""
    ...
    def get_transition_data(self: "modelWE", n_lag):    #SagarComments: Not Checked
        """
    ...
    def get_transition_data_lag0(self: "modelWE"):    #SagarComments: Checked and Changed,coordPairList[segs_contained, :, :, 1] = coords[:, - 1, :, :]
        """
        ...
        weightList = self.weightList  #load_iter_data
        coordPairList = np.zeros((self.nSeg, self.nAtoms, self.coord_ndim, 2))
        ...
        for idx, west_file in enumerate(west_files):
            ...
            with h5py.File(west_file, "r") as data_file:
                ...
                coordPairList[segs_contained, :, :, 1] = coords[:, - 1, :, :]
    ...
    def get_seg_histories(self: "modelWE", n_hist):   #SagarComments: Not Checked 
        """
    ...
    def collect_iter_coordinates(
        self: "modelWE",
    ):  # grab coordinates from WE traj_segs folder #SagarComments: Not Checked
        """
    ...
    def get_iter_coordinates(self: "modelWE", iteration):   #SagarComments: Checked and not changed as not realted
        """
    ...
    def load_iter_coordinates(self: "modelWE"):   #SagarComments:Checked and not changed as final structure was -1 from start
        """
    ...
    def load_iter_coordinates0(self: "modelWE"):  #SagarComments:Checked and not changed as initial structure realted
        coordList = np.full(
            (self.nSeg, self.nAtoms, self.coord_ndim), fill_value=np.nan
        )
        for iS in range(self.nSeg):
    ...
    def get_coordinates(self: "modelWE", first_iter, last_iter):  ##SagarComments:Not Checked
        """
        Unused
    ...
    def get_coordSet(self: "modelWE", last_iter, streaming=None, progress_bar=None): #SagarComments:Checked and not realted
        """
    ...
    def get_traj_coordinates(self: "modelWE", from_iter, traj_length):   ##SagarComments:Not Checked
    ...
    def load_iter_data(self: "modelWE", n_iter: int):  #SagarComments:Checked and Change to -1 for pcoord1List
        """
    ...
    def get_iterations(self: "modelWE"):   ##SagarComments: Checked and not related
        """
    ...
    def get_iterations_iters(self: "modelWE", first_iter: int, last_iter: int):  ##SagarComments: Checked and not related
        """
        Updates internal state with the maximum number of iterations, and the number of segments in each section.
